...
const ItemFormModal = ({
  ...
  useEffect(() => {
    ...
    if (editingItem) {
      setFormData({
        ...
        purchasePrice:
          editingItem.purchasePrice !== undefined
            ? Math.round(Number(editingItem.purchasePrice))
            : "",
  ...
  const cleanPriceStr =
    formData.purchasePrice !== "" && !isNaN(Number(formData.purchasePrice))
      ...
      : null;
  const secretPreview =
    cleanPriceStr !== null ? `347-${cleanPriceStr}` : "347-XXX";
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                {editingItem
                  ? "Update inventory specifications & secret price"
                  : "Enter part details to store in repair shop inventory"}
              </p>
            </div>
          </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs font-semibold text-blue-300">
                  Secret Price Code Auto-Generator
                </p>
                <p className="text-xs text-slate-400">
                  Random 3-digit prefix + separator line + exact price (e.g. 500
                  → #347 - 500)
                </p>
              </div>
            </div>
